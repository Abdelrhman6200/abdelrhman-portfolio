...
| Tier | Badge | Means |
| --- | --- | --- |
| `code` | SOURCE AVAILABLE | Shipped application. Architecture and tests are readable in source. |
| `demo` | INTERACTIVE DEMO | Runnable walkthrough built into this site under `/demo/*`. |
...
client/src/
  ...
  pages/DemoPages        Four in-site demos, routed under /demo/*.
